...
var ZSDKMessageManager = (function(ZSDKMessageManager) {
  ...
  function MessageHandler(MessageEvent) {
    ...
    try {
        ...
        if((eventName === 'SET_CONTEXT' && MessageEvent && MessageEvent.source === window.parent && MessageEvent.origin === SDKContext.QueryParams.serviceOrigin ) || isAuthorizedMessage(MessageEvent)) {
          switch(messageType) {
